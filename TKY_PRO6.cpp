...
#define ifilename "E:\\TKY_train7_prme_fused.txt"
#define test "E:\\TKY_prme_test.txt"
#define train "E:\\TKY_prme_train.txt"
...
void getTest(){
	...
	countPushback(vecucount, 2293, 110);//唉 以后再优化吧2293 110
